...
class TestParaLogic(unittest.TestCase):
    def test_simple_only_males(self):
        ...
        logic = Logic(event_list_csv, min_requirement_csv, world_champion_event_code=[], npc_max_number_of_males=2,
    ...
    def test_male_and_female(self):
        ...
        min_requirement_csv = [min_requirement_csv_header,
                               "50m Freestyle S3,MALE,01:00.00", "50m Freestyle S4,FEMALE,01:59.50"]
    ...
    def test_swimmers_with_multiple_results(self):
        ...
        logic = Logic(event_list_csv, min_requirement_csv, world_champion_event_code=[], npc_max_number_of_males=3,
                      npc_max_number_of_females=0, total_number_of_males=3, total_number_of_females=0,
                      csv_separator=',')
    ...
    def test_npc_cap_reached(self):
        ...
        logic = Logic(event_list_csv, min_requirement_csv, world_champion_event_code=[], npc_max_number_of_males=1,
                      npc_max_number_of_females=0, total_number_of_males=3, total_number_of_females=0,
                      csv_separator=',')
    ...
    def test_empty_event_files(self):
        ...
        # Empty with header
        logic = Logic(event_list_csv_with_header, min_requirement_csv, world_champion_event_code=[],
        ...
        logic = Logic(event_list_csv_without_header, min_requirement_csv, world_champion_event_code=[],
                      npc_max_number_of_males=2, npc_max_number_of_females=0, total_number_of_males=3,
                      total_number_of_females=0, csv_separator=',')
        list_of_npcs_and_swimmers = logic.calculate_npcs_numbers()
        self.assertEqual(0, len(list_of_npcs_and_swimmers))
